...
if __name__ == "__main__":
    """
    Here we simply loop over all of the machines in the queue.
    The assamption is that we are able to fullfil the task in under an hour
    Otherwise a different approach is needed. maybe async functionality to read\write from fs
